						...
						<div class="content-top">
							 ...
							 <div class="text">
								...
								<div class="grid_1_of_3 images_1_of_3">
									<div class="grid_1">
										<a href="single.html"><img src="{{asset('lib/storage/app/avatar/'.$prod->prod_img)}}" title="continue reading" alt=""></a>
											<div class="grid_desc">
												<p class="title">{{$prod->prod_name}}</p>
													...
													<div class="cart-button">
														<div class="cart">
														<a class="button" href="{{asset('details/'.$prod->prod_id.'/'.$prod->prod_slug)}}"><span>Details</span></a>
														</div>
