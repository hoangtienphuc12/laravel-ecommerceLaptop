...
<html>
<head>
    <base href="{{asset('./lib/resources/views/frontend/')}}/">
	...
	<div class="wrap"> 
		...
		<div class="menu"> 	
			<div class="top-nav"> 
					...
					<li><a href="{{asset('specials')}}">Specials</a></li>
						<li><a href="{{asset('news')}}">New</a></li>
		...
		<div class="header-para">
				<div class="categories">
						<div class="list-categories">
							...
							<div class="div_2"><a href="{{asset('sort/'.$cate->cate_id)}}">{{$cate->cate_name}}</a></div>
								<div class="div_img">
