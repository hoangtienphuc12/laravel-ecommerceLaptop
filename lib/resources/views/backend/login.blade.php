...
/* a.btn.btn-primary.btn-block.btn-large{
	visibility: hidden;
} */
.login { 
	position: absolute;
...
<div class="login">
	...
	<div class="form-group">
        ...
        <button type="submit" class="btn btn-primary btn-block btn-large" style="width:42% !important;display:inline !important ;height: 40px !important;">Login</button>
        <a href="{{asset('register')}}" type="submit" class="btn btn-primary btn-block btn-large" style="width:43% !important;display:inline !important;position:relative; bottom:4px;left:40px">Register</button>
    </form>
</div>
